...
class ErrorScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String displayTitle = title ?? context.t.errors.generalTitle;
    final String displaySubtitle =
        subtitle ?? context.t.errors.generalDescription;
        ...
        child: Column(
          ...
          children: [
            ...
            EvoElevatedButton(
              ...
              text: context.t.errors.generalRetryButtonText.toUpperCase(),
            ),
            const SizedBox(height: 16)
          ],
        ),
