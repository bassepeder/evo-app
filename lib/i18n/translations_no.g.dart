...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  // Translations
  late final TranslationsHomeScreenNo homeScreen =
      TranslationsHomeScreenNo.internal(_root);
  late final TranslationsMembershipStatusesNo membershipStatuses =
      TranslationsMembershipStatusesNo.internal(_root);
  late final TranslationsSignInScreenNo signInScreen =
      TranslationsSignInScreenNo.internal(_root);
  late final TranslationsValidationNo validation =
      TranslationsValidationNo.internal(_root);
  late final TranslationsWelcomeScreenNo welcomeScreen =
      TranslationsWelcomeScreenNo.internal(_root);
}
...
class TranslationsSignInScreenNo {
  ...
  late final TranslationsSignInScreenFormNo form =
      TranslationsSignInScreenFormNo.internal(_root);
  late final TranslationsSignInScreenButtonsNo buttons =
      TranslationsSignInScreenButtonsNo.internal(_root);
  late final TranslationsSignInScreenErrorMessagesNo errorMessages =
      TranslationsSignInScreenErrorMessagesNo.internal(_root);
}
...
class TranslationsValidationNo {
  ...
  // Translations
  late final TranslationsValidationFormsNo forms =
      TranslationsValidationFormsNo.internal(_root);
}
...
class TranslationsSignInScreenFormNo {
  ...
  // Translations
  late final TranslationsSignInScreenFormEmailNo email =
      TranslationsSignInScreenFormEmailNo.internal(_root);
  late final TranslationsSignInScreenFormPasswordNo password =
      TranslationsSignInScreenFormPasswordNo.internal(_root);
}
...
class TranslationsValidationFormsNo {
  ...
  // Translations
  late final TranslationsValidationFormsInputFieldsNo inputFields =
      TranslationsValidationFormsInputFieldsNo.internal(_root);
}
...
class TranslationsValidationFormsInputFieldsNo {
  ...
  // Translations
  late final TranslationsValidationFormsInputFieldsEmailNo email =
      TranslationsValidationFormsInputFieldsEmailNo.internal(_root);
  late final TranslationsValidationFormsInputFieldsPasswordNo password =
      TranslationsValidationFormsInputFieldsPasswordNo.internal(_root);
}
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      case 'homeScreen.membershipStatus':
        return 'Ditt medlemsskap er';
      case 'homeScreen.explore':
        return 'Utforsk medlemsskap';
      case 'homeScreen.currentLocationStatisticsTitle':
        return 'Antall personer nå inne på';
      case 'homeScreen.locationTimelineTitle':
        return 'Forventet besøk i dag hos';
      ...
      case 'signInScreen.subtitle':
        return 'Logg inn med e-posten og passordet ditt.';
      case 'signInScreen.form.email.label':
        return 'E-post';
      case 'signInScreen.form.email.hint':
        return 'Skriv inn e-postaddressen din';
      ...
      case 'signInScreen.errorMessages.invalidCredentials':
        return 'Brukernavn eller passord samsvarer ikke.';
