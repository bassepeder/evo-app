...
class _PaymentInformationScreenState
    extends ConsumerState<PaymentInformationScreen> with RouteAware {
  @override
  ...
  void _restartAnimations() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(animationVersionProvider.notifier).state++;
    });
  }
...
class PreviousPayments extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final animationVersion = ref.watch(animationVersionProvider);
              ...
              children: invoices
                  ...
                  .map((index, invoice) {
                    return MapEntry(
                      index,
                      FadeInPaymentCard(
                        key: ValueKey('${invoice.id}_$animationVersion'),
                        invoice: invoice,
                        index: index,
                      ),
                    );
...
final animationVersionProvider = StateProvider<int>((ref) => 0);
